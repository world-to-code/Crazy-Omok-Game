...
```bash
echo "$USER ALL=(ALL) NOPASSWD: /usr/bin/systemctl restart omok, /usr/bin/systemctl start omok, /usr/bin/systemctl stop omok, /usr/bin/systemctl is-active omok" | sudo tee /etc/sudoers.d/omok
